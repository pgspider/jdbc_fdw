...
-- PostgreSQL support create table with no column while MYSQL, GridDB do not, therefore, result for MYSQL, GridDB for table with no column will be error.
--Testcase 80:
CREATE FOREIGN TABLE nocols() SERVER :DB_SERVERNAME OPTIONS (table_name 'nocols');
--Testcase 81:
