...
CREATE TABLE float8_tbl (id SERIAL PRIMARY KEY, f1 float8);
CREATE TABLE float8_tmp (id SERIAL PRIMARY KEY, f1 float8, f2 float8);
CREATE TABLE float4_tbl (id SERIAL PRIMARY KEY, f1 float4);
...
CREATE TABLE inserttest (id int primary key, col1 int4, col2 int4 NOT NULL, col3 text default 'testing');

-- import data from csv file
\copy onek from '/tmp/jdbc/onek.data' with delimiter E'\t';
\copy onek2 from '/tmp/jdbc/onek.data' with delimiter E'\t';
\copy aggtest from '/tmp/jdbc/agg.data' with delimiter E'\t';
\copy tenk1 from '/tmp/jdbc/tenk.data' with delimiter E'\t';
\copy person from '/tmp/jdbc/person.data' with delimiter E'\t';
\copy tenk from '/tmp/jdbc/tenk.data' with delimiter E'\t';
\copy regr_test from '/tmp/jdbc/regr_test.data' with delimiter E'\t';
\copy int4_tbl from '/tmp/jdbc/int4_tbl.data' with delimiter E'\t';
\copy int8_tbl from '/tmp/jdbc/int8_tbl.data' with delimiter E'\t';
